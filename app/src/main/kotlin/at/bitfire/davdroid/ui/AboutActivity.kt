...
import at.bitfire.davdroid.Constants.OPEN_SOURECE
                    ...
                    Column(Modifier.padding(paddingValues)) {
                        ...
                        HorizontalPager(
                            ...
                            when (index) {
                                ...
                                1 -> {
                                    val translations =
                                        model.translations.observeAsState(emptyList())
...
fun AboutApp(
    ...
    Column(
        ...
        Text(
            stringResource(R.string.open_source_url),
            style = MaterialTheme.typography.bodyLarge.copy(color = Color.Blue,textDecoration = TextDecoration.Underline),
            modifier = Modifier
                .fillMaxWidth()
                .clickable {

                    uriHandler.openUri(OPEN_SOURECE.toString())
