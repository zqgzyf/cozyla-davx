...
object YahooLogin : LoginType {

    override val title
        get() = R.string.login_yahoo_url
    ...
    override fun LoginScreen(
        ...
        LaunchedEffect(Unit) {
            model.setUrl("https://caldav.calendar.yahoo.com")
        }
...
fun YahooLoginScreen(
    ...
    Assistant(
        ...
        Column(modifier = Modifier.padding(8.dp)) {
            Text(
                stringResource(R.string.login_yahoo_url),
